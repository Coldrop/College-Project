...
<article>
    ...
    <br>
        <p><a href="apply.php"><button class="button2" type="submit" value="Apply"><span>Apply</span></button></a>
    ...
    <br>
        <p><a href="apply.php"><button class="button3" type="submit" value="Apply"><span>Apply</span></button></a>
